package es.vicfuen.url_shortening_service.config;
...
@Configuration
@EnableCassandraRepositories(basePackages = "es.vicfuen.url_shortening_service.repository")
public class CassandraConfig extends AbstractCassandraConfiguration {
  ...
  public String[] getEntityBasePackages() {
    return new String[] { "es.vicfuen.url_shortening_service.repository.entity" };
  }
